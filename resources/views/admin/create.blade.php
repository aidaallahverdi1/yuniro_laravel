        ...
        <div class="row g-4">
            <div class="col-sm-10 col-xl-10 mx-auto">
                <div class="bg-secondary rounded h-100 p-4">
                    <h4 class="mb-4 text-primary">Create Post</h4>
                    <form class="row" method="post" action="{{route('post.save')}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="author" id="author" aria-describedby="author" >
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="publishD" class="form-label">Published Date</label>
                            <input type="date" class="form-control" name="published" id="publishD" aria-describedby="publishD" >
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="tags" id="Tag" aria-describedby="Tag" >
                        </div>
